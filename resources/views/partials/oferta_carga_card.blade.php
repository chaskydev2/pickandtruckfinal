@php
    ...
    // Texto del ribbon según los casos pedidos
    $ribbonText = null;
    if (!$iAmOwner) {
        if ($myBlockingBid) {
        ...
        <div class="row">
            ...
            <div class="col-md-8 border-end">
                ...
                <p class="text-muted mb-1">
                    <i class="fas fa-calendar me-2"></i>Fecha de carga:
                    <strong>{{ $oferta->fecha_inicio->format('d/m/Y h:i A') }}</strong>
                </p>
                <p class="text-muted mb-1">
                    <i class="fas fa-weight me-2"></i>Peso:
                    <strong>{{ number_format($oferta->peso, 2) }} kg</strong>
                </p>
                ...
                <p class="text-success mb-3 fw-bold">
                    ...
                    ${{ number_format($oferta->presupuesto, 2) }}
                </p>
                ...
                @php
                    // Alerta informativa si ya oferté (independiente del bloqueo)
                    $myAnyBid = Auth::check() ? $oferta->bids->firstWhere('user_id', Auth::id()) : null;
                @endphp
            ...
            <div class="col-md-4 d-flex flex-column">
                ...
                <div class="mt-auto">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('ofertas_carga.show', $oferta) }}" class="btn btn-outline-secondary">
