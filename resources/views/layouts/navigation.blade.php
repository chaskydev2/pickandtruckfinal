<nav x-data="{ open: false }" class="bg-nav border-b border-gray-700" style="position: sticky !important; top: 0 !important; z-index: 1000 !important; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
                        ...
                        <x-dropdown align="right" width="400">
                            <x-slot name="trigger">
                                <button
                                    ...
                                    {{-- Badge de nuevas notificaciones: solo renderizar si hay sin leer; cap a 99+ --}}
                                    @php
                                        $unread = auth()->user()->unreadNotifications->count();
                                    @endphp
                                    @if($unread > 0)
                                        <span id="notification-badge" class="notif-badge">
                                            {{ $unread > 99 ? '99+' : $unread }}
                                        </span>
                                    @endif
                                </button>
