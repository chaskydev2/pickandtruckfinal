...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100 auth-background">
        <div class="mt-6 mb-6 w-full max-w-md flex justify-center">
            <a href="/">
                <img src="{{ asset('images/pickntruck.png') }}" alt="PickNTruck Logo" class="w-auto h-16 max-w-full" style="max-height: 80px;">
            </a>
        </div>
